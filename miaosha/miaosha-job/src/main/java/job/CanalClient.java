...
public class CanalClient{
    ...
    public static void main(String[] args) {
        // 第一步：与canal进行连接
        CanalConnector connector = CanalConnectors.newSingleConnector(new InetSocketAddress("8.140.48.121", 11111),
                "example", "", "");
        connector.connect();
    ...
    public static void deleteCache(List<Column> columns, String tableName, String schemaName) {
        if ("stock".equals(tableName) && "miaosha".equals(schemaName)) {
